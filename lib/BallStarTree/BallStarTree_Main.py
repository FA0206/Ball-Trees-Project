...
csv_path = os.path.join(file_dir, '..', '..', 'Datasets', 'csv', 'latin_center_2d_500s.csv')  # Go up and locate Datasets
...
ball_star_tree = BallStarTree(data=data, leaf_size=50, max_iterations=100, alpha=0.5, S=10)
